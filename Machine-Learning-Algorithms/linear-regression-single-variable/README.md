...
### [Click here](https://github.com/369geofreeman/machine-learning-algorithms-and-data-structur    es/blob/main/Machine-Learning-Algorithms/linear-regression-single-variable/klinear-regression-from-scratch.py) To view linear Regression **built from scratch** and tested on the Swedish Insurance Dataset
